...
<div className="flex justify-between w-full md:hidden">
    ...
    <div className="bg-gray-100 border border-gray-200  rounded-full flex items-center justify-center">
      ...
      <div className="mt-3">
       ...
       <div className="relative flex-1  flex justify-between items-center md:ml-24   w-full  mt-4 sm:flex">
    

      
        <input
          className="w-72  h-10 md:w-96 md:rounded-full sm:h-12 pl-10 pr-12 rounded-lg border  border-gray-300 focus:outline-none"
        ...
        {/* <CiSliderHorizontal className="absolute right-3 top-1/2 transform -translate-y-1/2  
         ...
         <CiSliderHorizontal className="text-slate-400 text-4xl  md:absolute md:left-80 md:top-1/2 md:transform md:-translate-y-1/2"/>
         </div>
      ...
      <div className="flex items-center gap-4 ">
        ...
        {/* Profile Image */}
        <div className="hidden md:block bg-gray-100 border border-gray-200 p-1 rounded-full flex items-center justify-center">
          <img className="w-10 h-10 rounded-full " src="data:image/png;base64," alt="Profile" />
        </div>
      </div>
    </div>
  );
